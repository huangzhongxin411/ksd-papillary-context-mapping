...
version <- "v1.0.2"
version_dir <- "results/figures/figure3_revisions/v1.0.2_p1_gene_evidence_20260621"
dir.create(version_dir, recursive = TRUE, showWarnings = FALSE)
stem <- file.path(version_dir, "figure3_p1_gene_evidence_v1.0.2")
legend_path <- file.path(version_dir, "figure3_legend_v1.0.2.md")
notes_path <- file.path(version_dir, "figure3_revision_notes_v1.0.2.md")
source_path <- file.path(version_dir, "figure3_panel_source_files_v1.0.2.tsv")
qc_path <- file.path(version_dir, "figure3_visual_qc_v1.0.2.tsv")
...
notes_text <- paste0(
  "# Figure 3 revision notes (v1.0.2)\n\n",
  ...
  "12. v1.0.2 preserves v1.0/v1.0.1, removes narrow-panel subtitle overflow and explicitly maps role labels by gene after table merging. Remaining manual review: inspect at final journal placement size.\n")
...
message("Figure 3 v1.0.2 written to: ", version_dir)
