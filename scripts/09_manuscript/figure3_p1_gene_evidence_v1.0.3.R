...
version <- "v1.0.3"
version_dir <- "results/figures/figure3_revisions/v1.0.3_p1_gene_evidence_20260621"
dir.create(version_dir, recursive = TRUE, showWarnings = FALSE)
stem <- file.path(version_dir, "figure3_p1_gene_evidence_v1.0.3")
legend_path <- file.path(version_dir, "figure3_legend_v1.0.3.md")
notes_path <- file.path(version_dir, "figure3_revision_notes_v1.0.3.md")
source_path <- file.path(version_dir, "figure3_panel_source_files_v1.0.3.tsv")
qc_path <- file.path(version_dir, "figure3_visual_qc_v1.0.3.tsv")
...
notes_text <- paste0(
  "# Figure 3 revision notes (v1.0.3)\n\n",
  ...
  "12. v1.0.3 preserves all prior versions, shortens Panel B legend titles and moves Panel C numeric labels inward to eliminate edge clipping. Remaining action: minor manual review at journal placement size.\n")
...
message("Figure 3 v1.0.3 written to: ", version_dir)
