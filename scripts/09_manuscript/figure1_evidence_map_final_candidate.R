...
out_svg <- "results/figures/figure1_evidence_map_final_candidate.svg"
...
fwrite(manhattan_points,
  "results/tables/figure1_real_manhattan_card_points.tsv", sep = "\t")
...
writeLines(layer_map, "docs/figure1_figma_layer_map_final_candidate.md", useBytes = TRUE)
...
), "docs/figure1_legend_final_candidate.md", useBytes = TRUE)
...
qc <- data.table(
  ...
  canvas = "1560x930",
  pdf_exists = file.exists("results/figures/figure1_evidence_map_final_candidate.pdf"),
  png_exists = file.exists("results/figures/figure1_evidence_map_final_candidate.png"),
...
fwrite(qc, "results/tables/figure1_visual_qc_final_candidate.tsv", sep = "\t")
