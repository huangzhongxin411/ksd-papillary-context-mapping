...
version <- "v1.0.4"
version_dir <- "results/figures/figure3_revisions/v1.0.4_p1_gene_evidence_20260621"
dir.create(version_dir, recursive = TRUE, showWarnings = FALSE)
stem <- file.path(version_dir, "figure3_p1_gene_evidence_v1.0.4")
legend_path <- file.path(version_dir, "figure3_legend_v1.0.4.md")
notes_path <- file.path(version_dir, "figure3_revision_notes_v1.0.4.md")
source_path <- file.path(version_dir, "figure3_panel_source_files_v1.0.4.tsv")
qc_path <- file.path(version_dir, "figure3_visual_qc_v1.0.4.tsv")
...
notes_text <- paste0(
  "# Figure 3 revision notes (v1.0.4)\n\n",
  ...
  "12. v1.0.4 preserves all prior versions and left-aligns Panel B legends within their panel to eliminate edge clipping. Remaining action: minor manual review at journal placement size.\n")
...
message("Figure 3 v1.0.4 written to: ", version_dir)
