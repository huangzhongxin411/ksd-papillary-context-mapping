...
version_dir <- "results/figures/figure1_revisions/restored_real_manhattan_20260621"
dir.create(version_dir, recursive = TRUE, showWarnings = FALSE)

out_svg <- file.path(version_dir, "figure1_evidence_map_real_manhattan_restored.svg")
out_png <- file.path(version_dir, "figure1_evidence_map_real_manhattan_restored.png")
out_pdf <- file.path(version_dir, "figure1_evidence_map_real_manhattan_restored.pdf")
...
qc <- data.table(
  figure_id = "Figure 1",
  version = "restored_real_manhattan_20260621",
  canvas = "1560x930",
