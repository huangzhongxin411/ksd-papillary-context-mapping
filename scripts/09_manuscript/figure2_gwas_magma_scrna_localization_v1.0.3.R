...
version_dir <- "results/figures/figure2_revisions/v1.0.3_gwas_magma_scrna_20260621"
dir.create(version_dir, recursive = TRUE, showWarnings = FALSE)

stem <- file.path(version_dir, "figure2_gwas_magma_scrna_localization_v1.0.3")
legend_path <- file.path(version_dir, "figure2_legend_v1.0.3.md")
notes_path <- file.path(version_dir, "figure2_revision_notes_v1.0.3.md")
source_path <- file.path(version_dir, "figure2_panel_source_files_v1.0.3.tsv")
qc_path <- file.path(version_dir, "figure2_visual_qc_v1.0.3.tsv")
