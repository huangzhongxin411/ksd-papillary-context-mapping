...
ggsave("results/figures/figure4_gse73680_disease_context_v0.4.pdf", fig, width = 12.5, height = 8.8, units = "in", device = "pdf")
ggsave("results/figures/figure4_gse73680_disease_context_v0.4.png", fig, width = 12.5, height = 8.8, units = "in", dpi = 240)

writeLines(c(
  "# Figure 4 Legend v0.4",
  "",
...
), "docs/figure4_legend_v0.4.md")

message("wrote Figure 4 v0.4")
