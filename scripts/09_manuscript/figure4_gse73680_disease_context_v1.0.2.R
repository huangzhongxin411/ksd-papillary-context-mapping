...
version_dir <- "results/figures/figure4_revisions/v1.0.2_gse73680_disease_context_20260621"
dir.create(version_dir, recursive = TRUE, showWarnings = FALSE)
stem <- file.path(version_dir, "figure4_gse73680_disease_context_v1.0.2")
legend_path <- file.path(version_dir, "figure4_legend_v1.0.2.md")
notes_path <- file.path(version_dir, "figure4_revision_notes_v1.0.2.md")
source_path <- file.path(version_dir, "figure4_panel_source_files_v1.0.2.tsv")
qc_path <- file.path(version_dir, "figure4_visual_qc_v1.0.2.tsv")
...
message("Figure 4 v1.0.2 written to: ", version_dir)
