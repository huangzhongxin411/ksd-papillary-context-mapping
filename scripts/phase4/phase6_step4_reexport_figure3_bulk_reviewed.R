...
draw_main(main_pdf, main_png, main_png_600)
quit(save = "no", status = 0)
draw_supp_twas(supp_twas_pdf, supp_twas_png)
draw_full_matrix(supp_matrix_pdf, supp_matrix_png)
...
writeLines(c(
  ...
  "",
  "Supplementary full candidate evidence matrix. The full repaired candidate evidence matrix lists all genes included in the Phase 4-Step 2 repaired candidate model. MAGMA is the primary genetic-priority layer; snRNA is donor-level context support; TWAS is proxy annotation; spatial is supplementary context; and bulk disease-context status is reviewed and non-upgrading. Reporting groups are not causal tiers."
