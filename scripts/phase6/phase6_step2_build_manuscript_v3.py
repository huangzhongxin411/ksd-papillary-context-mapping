...
BASE_DOCX = ROOT / "docs/revision/stage7K_supervisor_review_compiled/manuscript_v2.5_with_latest_figures_supervisor_review.docx"
...
def update_header_footer(doc):
    ...
    r = fp.add_run("Manuscript v3.0 context-mapping revision | Page ")
    set_cell_text_font(r, 8)
...
def build_docx(md):
    ...
    fig_map = {
        ...
        "### Figure 3.": ROOT / "results/figures/phase4_step3_Figure3_candidate_reporting_model_polished_600dpi.png",
    ...
    out = OUTDIR / "manuscript_v3.0_context_mapping_revision.docx"
    doc.save(out)
...
def main():
    ...
    md = build_markdown()
    (OUTDIR / "manuscript_v3.0_context_mapping_revision.md").write_text(md, encoding="utf-8")
    build_docx(md)
