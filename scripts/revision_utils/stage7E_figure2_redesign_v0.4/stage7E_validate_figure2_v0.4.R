...
required <- c(
  "results/figures/revision/stage7E_figure2_redesign_v0.4/figure2_snRNA_context_draft_v0.4.pdf",
  "results/figures/revision/stage7E_figure2_redesign_v0.4/figure2_snRNA_context_draft_v0.4.png",
  "results/figures/revision/stage7E_figure2_redesign_v0.4/figure2_snRNA_context_draft_v0.4.svg",
  "docs/revision/stage7E_figure2_redesign_v0.4/figure2_qc_audit_v0.4.md",
  "results/tables/revision/stage7E_figure2_redesign_v0.4/figure2_visual_redesign_log_v0.4.tsv",
  "results/tables/revision/stage7E_figure2_redesign_v0.4/figure2_source_data_manifest_v0.4.tsv",
  "docs/revision/stage7E_figure2_redesign_v0.4/figure2_legend_v0.4.md",
  "docs/revision/stage7E_figure2_redesign_v0.4/stage7E_figure2_redesign_report.md"
)
...
check_true(identical(names(redesign), redesign_headers), "redesign_log_schema_exact")
check_true(identical(manifest$panel, LETTERS[1:7]), "source_manifest_panels_A_to_G")
check_true(identical(redesign$panel, LETTERS[1:7]), "redesign_log_panels_A_to_G")
check_true(all(manifest$data_changed_from_v0.3 == "no"), "manifest_data_changed_all_no")
check_true(all(manifest$claim_changed_from_v0.3 == "no"), "manifest_claim_changed_all_no")
...
check_true(all(redesign$human_review_needed == "yes"), "human_review_flag_all_yes")
...
required_text <- c(
  ...
  "Interpretation boundary", "Partial matched-random support", "Not causal", "Not plaque"
)
...
check_true(sum(grepl("\\| PASS \\|", qc_text)) == 10L, "all_10_requested_qc_items_pass")
check_true(any(grepl("summary-only", qc_text, fixed = TRUE)), "panel_E_summary_only_limitation_documented")

figure_dir <- file.path(root, "results/figures/revision/stage7E_figure2_redesign_v0.4")
check_true(length(list.files(figure_dir, pattern = "figure3", ignore.case = TRUE)) == 0L, "no_figure3_output_created")

qc_preview <- file.path(root, "logs/revision/stage7E_figure2_redesign_v0.4/figure2_snRNA_context_v0.4_qc_50pct.png")
...
log_path <- file.path(log_dir, "stage7E_figure2_v0.4_validation.log")
writeLines(c(
