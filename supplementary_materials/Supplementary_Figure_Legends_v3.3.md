# Supplementary Figure Legends v3.3

## Supplementary Figure S1. GWAS and MAGMA diagnostics

GWAS and MAGMA diagnostic panels complement the main-text quality-control Manhattan plot. Panels show (A) the GWAS quantile-quantile diagnostic, (B) the sampled GWAS P-value distribution, (C) the top 20 genes by MAGMA rank and (D) the sizes of the five prespecified MAGMA modules. The top-ranked genes in panel S1C represent gene-based priority and should not be interpreted as causal genes. Figure 1 remains a GWAS quality-control Manhattan visualization without gene labels.
